...
async function handler(req, res) {
    if (req.method === 'GET') {
        ...
        const logs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$helpers$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["getLogs"])(limit);
    ...
    if (req.method === 'DELETE') {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$helpers$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["clearLogs"])();
        return res.status(200).json({
            ok: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1qwsuy1._.js.map