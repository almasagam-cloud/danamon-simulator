...
"[project]/src/pages/api/sim/jns.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (scenario === 'sms_fail') {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$helpers$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["appendLog"])({
            endpoint: 'jns',
            method: 'POST',
        ...
        return res.status(config.jns_error_status).setHeader('Content-Type', 'application/x-www-form-urlencoded').send(config.jns_error_body);
    }
    // ── sms_success ────────────────────────────────────────────
    const responseBody = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$helpers$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["interpolateJnsSuccess"])(config.jns_success_body);
    ...
    // Auto-send SMS delivery report to callback URL after delay
    const cbUrl = config.callback_url;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$helpers$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["scheduleDR"])(cbUrl, {
        messageId,
        status: '1',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__214rezh._.js.map