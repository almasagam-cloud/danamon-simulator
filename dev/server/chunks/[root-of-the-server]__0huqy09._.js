...
"[project]/src/pages/api/sim/coster.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    const body = req.body || {};
    const to = body?.to || body?.contacts?.[0]?.input || 'unknown';
    const headers = {};
    ...
    if (scenario === 'wa_fail') {
        ...
        return res.status(config.coster_error_status).setHeader('Content-Type', 'application/json').send(responseBody);
    }
    // ── wa_success / wa_delivered_before_sent / wa_threshold_expire ─
    const responseBody = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$helpers$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["interpolateCosterSuccess"])(config.coster_success_body, to);
    let parsedResponse;
    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0huqy09._.js.map